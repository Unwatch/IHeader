(function(ns) {
  ...
  var Message = (function() {
    ...
    //收到native messaging host的反馈后,转发给web page
    //chrome.runtime.onMessage.addListener(onMessage);
    chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
      if (request.data != null) {
        console.log("get response from extension" + request.data);
        alert(" chrome.runtime.onMessage.addListener in message.js");
    ...
    if (chrome.runtime.onMessageExternal) {
      chrome.runtime.onMessageExternal.addListener(function(data, sender, sendResponse) {
        alert(" chrome.runtime.onMessageExternal.addListener in message.js");
        console.log("chrome.runtime.onMessageExternal.addListener in message.js");
